...
4. [Brand 360° Profile](#brand-360-profile)
...
```
┌─────────────────────────────────────────────────────────┐
│  VistralAI Dashboard          [Account] [Logout]       │
├─────────────────────────────────────────────────────────┤
│                                                         │
│  ┌─────────────────────────────────────────────────────┐ │
│  │ AI Visibility Score: 72/100 ↑ 8pts (↑12% this mo.)│ │
│  └─────────────────────────────────────────────────────┘ │
│                                                         │
│  ┌────────────────┐ ┌────────────────┐ ┌────────────────┐ │
│  │ Mentions       │ │ Share of Voice │ │ Sentiment      │ │
│  │ 342 (+15%)     │ │ 12.5% (+2.1%) │ │ 78% Positive  │ │
│  └────────────────┘ └────────────────┘ └────────────────┘ │
│                                                         │
│  ┌─────────────────────────────────────────────────────┐ │
│  │ AI Mentions Over Time (Last 30 days)               │ │
│  │ [Line chart showing trend]                         │ │
│  └─────────────────────────────────────────────────────┘ │
│                                                         │
│  ┌────────────────┐ ┌────────────────┐ ┌────────────────┐ │
│  │ Top AI Models  │ │ Top Competitors │ │ Optimization  │ │
│  │ - ChatGPT (42%)│ │ - Competitor A  │ │ - Add products│ │
│  │ - Claude (28%) │ │ - Competitor B  │ │ - Improve SEO │ │
│  │ - Gemini (18%) │ │ - Competitor C  │ │ - More content│ │
│  └────────────────┘ └────────────────┘ └────────────────┘ │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
The Brand 360° Profile is your comprehensive brand knowledge base that powers more accurate AI visibility insights. It contains four key pillars of information:
...
1. Click **"Brand 360° Profile"** in the sidebar
...
```
Overall Strength: 62/100 ▓▓▓▓▓▓░░░░ (Moderate)

Pillar Completion:
├── Identity:        ▓▓▓▓░░░░░░ (45%)  👈 [Complete Section]
├── Market Position: ▓▓▓▓▓▓▓░░░ (73%)  👈 [Edit]
├── Competitors:     ▓▓▓▓▓▓▓▓░░ (85%)  👈 [Edit]
└── Products:        ▓▓▓▓▓▓▓▓▓░ (92%)  👈 [Edit]
```
...
│ ⚠ Review Required                               │
│                                                 │
│ We found 3 fields that need your review:       │
│                                                 │
│ Field: Mission Statement                        │
│ AI Extracted: "Helping businesses grow..."     │
│ Your Review: [ ] Approve [ ] Edit [ ] Reject   │
│                                                 │
│ If editing, provide feedback for improvement:  │
│ [Text area for feedback]                        │
│                                                 │
│ [Cancel] [Skip for Now] [Submit Review]       │
└─────────────────────────────────────────────────┘
```
...
- ✓ Brand Profile populated with extracted data
- ✓ Profile strength score updated
- ✓ Ready for AI Visibility analysis
- ✓ Recommendations for improvement

**Next steps**:
1. Review your Brand 360° Profile
...
│ Statistics:                                         │
│  • Total: 12 reviews                               │
│  • Pending: 3 (need your review)                   │
│  • Approved: 8                                      │
│  • Rejected: 1                                      │
│                                                     │
│ ──────────────────────────────────────────────────  │
│                                                     │
│ [ ] Mission Statement        Confidence: 78%       │
│     Approve | Edit | Reject                        │
│                                                     │
│ [ ] Core Values             Confidence: 82%        │
│     Approve | Edit | Reject                        │
│                                                     │
│ [ ] Target Audience         Confidence: 71%        │
│     Approve | Edit | Reject                        │
│                                                     │
│ ──────────────────────────────────────────────────  │
│                                                     │
...
│                                                  │
│ AI Extracted Value:                              │
│ "Helping businesses scale their operations"     │
│                                                  │
│ [ ] Approve - Extracted value is correct       │
│                                                  │
│ [X] Edit - Change the value                    │
│     [Text field with extracted value]           │
│     Feedback (optional):                        │
│     [Text area]                                 │
│     Example: "Added 'globally' to match our    │
│     expanded market focus"                      │
│                                                  │
│ [ ] Reject - Wrong, need to start over         │
│                                                  │
...
│                                                     │
│ ChatGPT:    ▓▓▓▓▓░░░░░ 52% (342 mentions)         │
│ Claude:     ▓▓▓▓░░░░░░ 38% (258 mentions)         │
│ Gemini:     ▓▓▓░░░░░░░ 28% (192 mentions)         │
│ Perplexity: ▓░░░░░░░░░ 12% (82 mentions)          │
│ Meta AI:    ░░░░░░░░░░  5% (34 mentions)           │
│                                                     │
...
│                                                     │
│ Mention Frequency:                                 │
│ [Line chart showing 30-day trend] ↗ +12%          │
│                                                     │
└─────────────────────────────────────────────────────┘
```
...
Based on your Brand 360° Profile and AI visibility, VistralAI provides actionable recommendations:
...
Blog Post Ideas:
• "How [Brand] Solves Problem X" (addresses gap identified
  in AI descriptions)
• "[Brand] vs [Competitor]: Detailed Comparison"
  (improves mention context)
• "Getting Started with [Brand]" (improve tutorials
  mentioned in AI models)

Product Documentation:
• Use case: E-commerce integration (gap in current docs)
• Case study: Customer success story (builds credibility)
• Feature explainer: Your top differentiator

Keywords to Target:
• "Feature" + "use case" (high intent combination)
• "[Industry] solution" (improves market positioning)
• "[Brand] alternative" (competitive positioning)
```
...
│                                                    │
│ Share of Voice:                                    │
│ Your Brand:    12.5% (↑ 2.1% this month)         │
│ Competitor A:  18.2%                              │
│ Competitor B:   9.8%                              │
│ Competitor C:  11.4%                              │
│ Others:        48.1%                              │
│                                                    │
│ Sentiment:                                         │
│ Your Brand:    78% positive                        │
│ Competitor A:  82% positive                        │
│ Competitor B:  71% positive                        │
│ Competitor C:  75% positive                        │
│                                                    │
└────────────────────────────────────────────────────┘
```
...
A: Typically 80-90% accurate for brand identity and products. The review queue catches low-confidence items. Accuracy improves with better Brand 360° data.

**Q: Can I manually edit my brand profile?**
A: Yes! Click "Edit" on any section to modify. Your changes are saved immediately.

**Q: How do I add new products?**
A: Go to Brand 360° → Products → "Add Product" and fill in the details.
...
A: It goes back to extraction. You can manually enter the correct information in your Brand 360° Profile.
...
A: Yes! Go to AI Visibility → "By Model" and you'll see breakdown by ChatGPT, Claude, Gemini, etc.
...
A: Yes. Click "Settings" → "Billing" → "Cancel Subscription". You keep access through end of current month.
...
1. **Keep your Brand 360° Profile updated**
   - Review quarterly
