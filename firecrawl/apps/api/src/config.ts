...
const configSchema = z.object({
  ...
  CRAWL_CACHE_TTL_MS: z.coerce.number().default(31536000000), // 365 days in milliseconds (365 * 24 * 60 * 60 * 1000)
  ENABLE_CROSS_CRAWL_CACHE: z.stringbool().optional(), // Enable caching of scraped URLs across different crawls
